					...
					<div class="row">
						<div class="col-md-6">
							<div class="price-card " data-toggle="modal" data-target="#joinTeam">
								<h2>Join the adult Night League</h2>
								<p class="price"><span>40</span></p>
								<a href="" class="btn btn-inverse btn-mid">Buy Now</a>
							</div>
						</div>
						<div class="col-md-6">
							<a href="https://form.jotform.com/82906416856264">
								<div class="price-card featured">
									<h2>Youth League Sign Up</h2>
									<p class="price"><span>95</span></p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 ">
							...
							<p class="description"> FOR THE COMMUNITY. BY THE COMMUNITY. Ball Till I Fall Canada, a Social Enterprise founded & created by 21-year-old Adam B. Halawa in the year 2015. Adam B. lives in Ottawa Community Housing projects, is a University of Ottawa graduate, a citizen of the world and an entrepreneur at heart. It all started with the notion of “Want for your brother  & sister what you want for yourself”. Adam B. Halawa</p>
						</div>
						<div class="col-md-6 ">
							<div style="position:relative;height:0;padding-bottom:56.22%"><iframe src="https://www.youtube.com/embed/0EhdYa-cVUE?ecver=2" style="position:absolute;width:100%;height:100%;left:0" width="640" height="360" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>
						</div>
						</div>
					</div>
				</div>
