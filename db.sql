...
(2, 'Dana Ghazi', 'balltillifallottawa@gmail.com', '$2y$10$P7wJ5UiKKJomXLIXpazMkOHqFsVCD.3Wnuf0wUKut5PKww59FErKW');
...
CREATE TABLE `teams` (
  ...
  `team_image` varchar(100) NOT NULL DEFAULT 'http://balltillifall.ca/img/teams/default.png'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
